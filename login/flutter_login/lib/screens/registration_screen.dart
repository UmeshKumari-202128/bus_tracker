...
import 'package:flutter_login/model/user_modal.dart';
...
// Last Name Field
    final lastNameField = TextFormField(
      ...
      validator: (value) {
        ...
        if (!regex.hasMatch(value)) {
          return ("Please Enter Valid Last Name (min. 3 character)");
        }
      },
      onSaved: (value) {
...
// Confirm password field
  ...
  postDetailsToFirestore() async {
    ...
    Navigator.pushAndRemoveUntil((context),
        MaterialPageRoute(builder: (contex) => HomeScreen()), (route) => false);
  }
}
